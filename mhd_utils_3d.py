...
def write_mhd(mhdfile, data, dsize, esize):
    ...
    offset = range(0,len(dsize));
    for i in offset:
        offset[i] = -esize[i]*(dsize[i]-1)/2.0
    ...
    meta_dict['ElementSpacing'] = ' '.join([str(i) for i in esize])
